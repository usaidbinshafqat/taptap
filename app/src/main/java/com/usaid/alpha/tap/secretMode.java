...
public class secretMode extends AppCompatActivity {
    int scoreP1 = 0;
    int scoreP2 = 0;
    ...
    public void showMessage(String title, String message){
        android.support.v7.app.AlertDialog.Builder builder1 = new android.support.v7.app.AlertDialog.Builder(secretMode.this);
