...
public class BestSixty extends AppCompatActivity {
    int scoreP1 = 0;
    int scoreP2 = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_best_sixty);
    }
    ...
    public void increaseP1(View view) {
        ...
        if (scoreP1 == 60) {
            ...
            if (rand < 0.25) {
                ...
                showMessage("PBlue Won!", "Red Player, you suck. ");
            }
            else {
    ...
    public void showMessage(String title, String message){
        android.support.v7.app.AlertDialog.Builder builder1 = new android.support.v7.app.AlertDialog.Builder(BestSixty.this);
